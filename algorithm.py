...
def save_result(HDR_result):
    ...
    cv.imwrite("./Test Images/5/consistent/Result.jpg", result_image)
...
if __name__ == "__main__":
    ...
    paths = ["./Test Images/5/consistent/1.jpeg",
             "./Test Images/5/consistent/2.jpeg",
             "./Test Images/5/consistent/3.jpeg",
             "./Test Images/5/consistent/4.jpeg"]
    images = readImagesAndTimes(paths)
    merge_mertens = cv.createMergeMertens()
    fusion = merge_mertens.process(images)
    fusion_8bit = np.clip(fusion * 255, 0, 255).astype('uint8')
    cv.imwrite("./Test Images/5/consistent/fusion_result.png", fusion_8bit)
    ...
    plt.savefig('./Test Images/5/consistent/CRF.png')
    plt.show()
